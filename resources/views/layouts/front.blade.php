        ...
        <div class="container py-1">
            <div class="row align-items-center">
                <div class="col-8 col-md-8 col-lg-4">
                    <h1 class=""><a href="/" class="h5 text-uppercase text-black"><strong>{{ config('app.name') }}<span
                ...
                <div class="col-4 col-md-4 col-lg-8">
                    <nav class="site-navigation text-right text-md-right" role="navigation">
                        ...
                        <ul class="site-menu js-clone-nav d-none d-lg-block">
                            ...
                            <li class="has-children">
                                ...
                                <ul class="dropdown">
                                    @foreach ($globalEventTypes as $eventType)
                                        <li>
                                            <a href="{{ route('event_type', $eventType->slug) }}">{{ $eventType->name }}</a>
                                        </li>
                                    @endforeach
                                </ul>
                            </li>
                            ...
                            <li><a href="{{ url('artists/create') }}">Register</a></li>
